	...
	<div>
		...
		<div class="container">
			<el-form class='rgs-form animate__animated animate__' v-if="pageFlag=='register'" ref="registerForm" :model="registerForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">基于Python的安徽新华学院人事管理系统设计与实现</p></div>
					<el-form-item class="list-item" v-if="tableName=='yuangong'" prop="yuangongzhanghao">
						<div class="label" :class="changeRules('yuangongzhanghao')?'required':''">员工账号：</div>
						<el-input v-model="registerForm.yuangongzhanghao"  placeholder="请输入员工账号" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='yuangong'" prop="mima">
						<div class="label" :class="changeRules('mima')?'required':''">密码：</div>
						<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='yuangong'" prop="mima2">
						<div class="label" :class="changeRules('mima')?'required':''">确认密码：</div>
						<el-input v-model="registerForm.mima2" type="password" placeholder="请再次输入密码" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='yuangong'" prop="yuangongxingming">
					...
					<el-form-item class="list-item" v-if="tableName=='yuangong'" prop="xingbie">
					...
					<el-form-item class="list-item" v-if="tableName=='yuangong'" prop="lianxidianhua">
					...
					<el-form-item class="list-item" v-if="tableName=='yuangong'" prop="touxiang">
					...
					<el-form-item class="list-item" v-if="tableName=='renshizhuguan'" prop="zhanghao">
						<div class="label" :class="changeRules('zhanghao')?'required':''">账号：</div>
						<el-input v-model="registerForm.zhanghao"  placeholder="请输入账号" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='renshizhuguan'" prop="mima">
						<div class="label" :class="changeRules('mima')?'required':''">密码：</div>
						<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='renshizhuguan'" prop="mima2">
						<div class="label" :class="changeRules('mima')?'required':''">确认密码：</div>
						<el-input v-model="registerForm.mima2" type="password" placeholder="请再次输入密码" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='renshizhuguan'" prop="xingming">
						<div class="label" :class="changeRules('xingming')?'required':''">姓名：</div>
						<el-input v-model="registerForm.xingming"  placeholder="请输入姓名" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='renshizhuguan'" prop="xingbie">
						<div class="label" :class="changeRules('xingbie')?'required':''">性别：</div>
						<el-select v-model="registerForm.xingbie" placeholder="请选择性别" >
							<el-option
					...
					<el-form-item class="list-item" v-if="tableName=='renshizhuguan'" prop="touxiang">
						<div class="label" :class="changeRules('touxiang')?'required':''">头像：</div>
						<file-upload
							tip="点击上传头像"
							action="file/upload"
					...
					<el-form-item class="list-item" v-if="tableName=='renshizhuguan'" prop="lianxidianhua">
						<div class="label" :class="changeRules('lianxidianhua')?'required':''">联系电话：</div>
						<el-input v-model="registerForm.lianxidianhua"  placeholder="请输入联系电话" />
					</el-form-item>
...
export default {
	...
	mounted() {
		if(this.$route.query.pageFlag=='register'){
			...
			if(this.tableName=='renshizhuguan'){
				this.registerForm = {
					zhanghao: '',
					mima: '',
					mima2: '',
			...
			if ('renshizhuguan' == this.tableName) {
		...
		submitForm(formName) {
			this.$refs[formName].validate((valid) => {
				if (valid) {
					...
					if(`renshizhuguan` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
						this.$message.error(`两次密码输入不一致`);
						return
					}
