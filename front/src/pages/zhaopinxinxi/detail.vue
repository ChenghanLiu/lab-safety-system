		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						...
						<div class="text "  >{{detail.gongsimingcheng}}</div>
					</div>
					<div class="item">
						<div class="lable">招聘要求</div>
						<div class="text "  >{{detail.zhaopinyaoqiu}}</div>
					</div>
					<div class="item">
			...
			<el-tabs class="detail-tabs" v-model="activeName" type="border-card" v-if="tabsNum>0" >
				<el-tab-pane label="招聘详情" name="first">
					<div class="ql-snow ql-editor" v-html="detail.zhaopinxiangqing"></div>
				</el-tab-pane>
			</el-tabs>
