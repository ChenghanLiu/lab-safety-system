...
// 					// }
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other >>> .el-submenu__title {
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other >>> .el-submenu__title:hover {
		color: #ff0 !important;
		background: url(http://codegen.caihongy.cn/20240921/843a44ac82df4f9caf6462715a95a854.png) no-repeat right center / auto 60% !important;
	}
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other.is-active >>> .el-submenu__title {
		color: #ff0 !important;
		background: url(http://codegen.caihongy.cn/20240921/843a44ac82df4f9caf6462715a95a854.png) no-repeat right center / auto 60% !important;
	}
	
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other >>> .el-submenu__title .iconfont {
		border-radius: 100%;
		margin: 0 3px 6px;
		color: inherit;
		background: #0356bb;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other >>> .el-submenu__title .el-submenu__icon-arrow {
		margin: -7px 0 0 0;
		top: 50%;
		color: inherit;
		display: none;
	...
	.scrollbar-wrapper-close .el-menu-vertical-2 .el-submenu.other >>> .el-submenu__title {
		cursor: pointer !important;
	...
	.scrollbar-wrapper-close .el-menu-vertical-2 .el-submenu.other >>> .el-submenu__title:hover {
		color: #fff !important;
		background: blue !important;
	}
	
	.scrollbar-wrapper-close .el-menu-vertical-2 .el-submenu.other >>> .el-submenu__title .iconfont {
		margin: 0;
		color: inherit;
	...
	.scrollbar-wrapper-close .el-menu-vertical-2 .el-submenu.other >>> .el-submenu__title .el-submenu__icon-arrow {
		margin: -7px 0 0 0;
		top: 50%;
		color: inherit;
		display: none;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home >>> .el-submenu__title {
		cursor: pointer !important;
		padding: 5px !important;
		color: #fff !important;
		white-space: nowrap !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home >>> .el-submenu__title:hover {
		color: #ff0 !important;
		background: url(http://codegen.caihongy.cn/20240921/843a44ac82df4f9caf6462715a95a854.png) no-repeat right center / auto 60% !important;
	}
	
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home >>> .el-submenu__title .iconfont {
		border-radius: 100%;
		margin: 0 3px 6px;
		color: inherit;
		background: #0356bb;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.home >>> .el-submenu__title .el-submenu__icon-arrow {
		margin: -7px 0 0 0;
		top: 50%;
		color: inherit;
		display: none;
	...
	.scrollbar-wrapper-close .el-menu-vertical-2 .el-submenu.home >>> .el-submenu__title {
		cursor: pointer;
		padding: 0 20px;
		color: #333;
		white-space: nowrap;
	...
	.scrollbar-wrapper-close .el-menu-vertical-2 .el-submenu.home >>> .el-submenu__title:hover {
		color: #fff;
		background: blue;
	}
	
	.scrollbar-wrapper-close .el-menu-vertical-2 .el-submenu.home >>> .el-submenu__title .iconfont {
		margin: 0;
		color: inherit;
		display: inline-block;
		vertical-align: middle;
	...
	.scrollbar-wrapper-close .el-menu-vertical-2 .el-submenu.home >>> .el-submenu__title .el-submenu__icon-arrow {
		margin: -7px 0 0 0;
		top: 50%;
		color: inherit;
		display: none;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.user >>> .el-submenu__title {
		cursor: pointer !important;
		padding: 5px !important;
		color: #fff !important;
		white-space: nowrap !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.user >>> .el-submenu__title:hover {
		color: #ff0 !important;
		background: url(http://codegen.caihongy.cn/20240921/843a44ac82df4f9caf6462715a95a854.png) no-repeat right center / auto 60% !important;
	}
	
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.user >>> .el-submenu__title .iconfont {
		border-radius: 100%;
		margin: 0 3px 6px;
		color: inherit;
		background: #0356bb;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.user >>> .el-submenu__title .el-submenu__icon-arrow {
		margin: -7px 0 0 0;
		top: 50%;
		color: inherit;
		display: none;
	...
	.scrollbar-wrapper-close .el-menu-vertical-2 .el-submenu.user >>> .el-submenu__title {
		cursor: pointer !important;
		padding: 0 20px !important;
		color: #333 !important;
		white-space: nowrap !important;
	...
	.scrollbar-wrapper-close .el-menu-vertical-2 .el-submenu.user >>> .el-submenu__title:hover {
		color: #fff !important;
		background: blue !important;
	}
	
	.scrollbar-wrapper-close .el-menu-vertical-2 .el-submenu.user >>> .el-submenu__title .iconfont {
		margin: 0;
		color: inherit;
		display: inline-block;
		vertical-align: middle;
	...
	.scrollbar-wrapper-close .el-menu-vertical-2 .el-submenu.user >>> .el-submenu__title .el-submenu__icon-arrow {
		margin: -7px 0 0 0;
		top: 50%;
		color: inherit;
		display: none;
